...
const HomeDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7] pb-20 font-sans text-slate-900">
      ...
      {/* 3. Main Content Grid */}
      <main className="max-w-7xl mx-auto px-8 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-8">
          ...
          {/* Amenities Summary */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 border-t border-slate-200">
